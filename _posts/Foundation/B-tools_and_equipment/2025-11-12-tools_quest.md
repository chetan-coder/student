...
![Github Account]({{site.baseurl}}/media/assets/github.png)
...
![Setup MacOS Terminal]({{site.baseurl}}/media/assets/terminal.png)
...
![Visual Studio Code]({{site.baseurl}}/media/assets/vscode.png)
...
![Forked Student Repository]({{site.baseurl}}/media/assets/repositories.png)
...
![VS Code Termonal]({{site.baseurl}}/media/assets/vscodeterminal.png)
...
![Commits]({{site.baseurl}}/media/assets/commits.png)
